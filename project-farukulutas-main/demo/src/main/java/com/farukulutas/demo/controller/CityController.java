...
public class CityController {
    ...
    public ResponseEntity<String> getCityInfo(@RequestParam String cityName, @RequestParam(required = false, defaultValue = "") LocalDate startDate, @RequestParam(required = false, defaultValue = "") LocalDate endDate ) throws ParseException {
